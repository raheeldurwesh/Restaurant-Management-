      ...
      <div className="fixed inset-x-0 bottom-0 z-50 flex flex-col
              ...
              <div>
                ...
                <input type="text" value={customerName}
                       ...
                       className="w-full bg-card border border-border rounded-xl
                                  text-bright placeholder-muted font-body text-sm
        ...
        {cart.length > 0 && (
          <div className="px-5 py-4 border-t border-border space-y-3 bg-surface flex-shrink-0">
            ...
            {/* Cooldown error */}
            {orderError && (
              <div className="bg-danger/10 border border-danger/30 rounded-xl px-4 py-2">
                <p className="text-danger text-xs font-body text-center">⏳ {orderError}</p>
              </div>
            )}
